...
logging.basicConfig(filename="new-l3vlan.log", filemode='a', format='%(asctime)s.%(msecs)03d %(levelname)s - %(funcName)s: %(message)s',  datefmt='%Y-%m-%d %H:%M:%S')
...
parser.add_argument("--a", required=True, type=IPv4Interface, help="IPv4 Anycast Address")
parser.add_argument("--b", required=True, type=IPv6Interface, help="IPv6 Anycast Address")
...
# Create VLAN
nested = {
    "gatewayIpAddress": ipv4,
    "gatewayIpV6Address":ipv6,
    "vlanName":vlanName,
